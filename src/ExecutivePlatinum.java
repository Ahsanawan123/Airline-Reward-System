 ...
 * (If passenger has 100, or more cancellations, they are put into the Gold tier)
 *
 * @Author Ahsan Awan
 * @Version 1.0
 */
public class ExecutivePlatinum extends Tier {
    ...
    /**
     * Creates an object and assigns the variables respectively
     */
    ExecutivePlatinum (int Mi, int numCanFlights, int numTotFlights)
    {
        miles = Mi;
        numOfCanceledFlights = numCanFlights;
        numOfTotFlights = numTotFlights;
    } // End of executivePlatinum
...
} // End of public Class ExecutivePlatinum

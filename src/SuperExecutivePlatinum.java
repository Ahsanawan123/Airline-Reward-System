 ...
 * (If passenger has 100 or more cancellations, and they haven't complained throughout the whole year, they are put
...
public class SuperExecutivePlatinum extends Tier {
     ...
     */
    SuperExecutivePlatinum (int Mi, int numCanFlights, int numTotFlights) {
        miles = Mi;
        numOfCanceledFlights = numCanFlights;
        numOfTotFlights = numTotFlights;
    } // End of super executive platinum
...
} // End of public Class SuperExecutivePlatinum
